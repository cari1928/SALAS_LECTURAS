...
if (isset($_GET['info1'])) {
    $sql = "select distinct sala.cvesala,ubicacion,sala.horario,fechainicio,fechafinal from lectura  inner join sala on sala.cvesala=lectura.cvesala and lectura.horario=sala.horario inner join periodo on periodo.cveperiodo = lectura.cveperiodo
    where cveletra in (select cve from abecedario where letra='" . $_GET['info1'] . "') and
    sala.cvesala='" . $_GET['info2'] . "' and sala.horario='" . $_GET['info3'] . "' and cvepromotor='" . $_SESSION['cveUser'] . "'";
