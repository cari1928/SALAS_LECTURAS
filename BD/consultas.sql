select cve_sala, letra from lectura inner join abecedario on abecedario.cve = lectura.cveletra where cvepromotor='3333333333333'
...
where lectura.cvepromotor='2222222222222'
	...
	and nocontrol in (select nocontrol from lectura where nocontrol ='11111111')
