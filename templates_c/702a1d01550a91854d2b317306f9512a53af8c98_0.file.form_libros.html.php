<?php
/* Smarty version 3.1.30-dev/53, created on 2017-07-20 01:46:04
  from "/home/ubuntu/workspace/templates/admin/form_libros.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_59700b5c721f48_61231965',
...
function content_59700b5c721f48_61231965 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <div class="main row">
    <nav class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3">
      ...
      <form class="form form-vertical" method="post" enctype="multipart/form-data" 
        action="libros.php?accion=<?php if (isset($_smarty_tpl->tpl_vars['libros']->value)) {?>update<?php } else { ?>insert<?php }?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="sinopsis" required 
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['libros']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['libros']->value['sinopsis'];?>
 <?php }?>
                      </textarea>
                    </div>
                  </div>
...
<?php echo '<script'; ?>
 type="text/javascript">
  ...
  $("#portada").fileinput({
    initialPreview: ['../Images/portadas/<?php echo $_smarty_tpl->tpl_vars['portada']->value;?>
'],
    initialPreviewConfig: [ 
      { 
        caption: "<?php echo $_smarty_tpl->tpl_vars['portada']->value;?>
", size: 930321, width: "120px", key: 1, showDelete: false 
      }
    ],  
    maxFileSize: 1500,
    showClose: false,
