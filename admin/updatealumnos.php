...
if ($_SESSION['roles'] =='A')
{
	...
	if (!isset($_POST['datos'])) 
	{
		...
		contenidos($nombre,$cveUser,"",$web,"updatealumnos");
	}
	else
	{
			...
			if ($_POST['datos']['contrasena']!="" && $_POST['datos']['contrasenaN']!="" && $_POST['datos']['confcontrasenaN']!="") 
			{
				...
				if($datos_rs[0]['pass']==$cont)
				{
					...
					else
					{
						...
						contenidos($nombre,$cveUser,"No coinciden las nuevas contraseñas",$web,"updatealumnos");						
					}
				}
				else
				{
					contenidos($nombre,$cveUser,"No coincide la contraseña original",$web,"updatealumnos");							
				}
			}	
		}
		else
