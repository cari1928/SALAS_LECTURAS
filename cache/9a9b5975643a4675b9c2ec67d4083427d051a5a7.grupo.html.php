<?php
/* Smarty version 3.1.30-dev/53, created on 2017-01-21 05:32:53
  from "/home/ubuntu/workspace/templates/admin/grupo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5882f2854c56e0_77225687',
...
function content_5882f2854c56e0_77225687 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div><label><a href="index.php">index</a></label> > <label><a href="promotor.php">promotor</a></label> > <label>grupo-B</label></div>
  	...
  	<table class='table table-striped' width='500'>
  		<tr>
  		  <th><center>ALUMNO</center></th>        <th><center>COMPRENSIÓN</center></th> 
        ...
        <th><center>OPCIONES</center></th>  		</tr>
  		  			<tr> 
  				 <form class='form-inline' action='grupo.php?info1=' method='post' >
  					 <input type="hidden" name="datos[nocontrol]" value="12030366" > 
  					 <td width='500'>Gonzáles Freyre Isabel</td>  					 <td width='500'>  
  					...
  					<td width='500'>
  					 ...
  					 <!--Para que no se muestre en la sección del alumno-->
  					  <td><center>
    						<!--<a href="redacta.php?accion=redactarI&info=&receptor=12030366&periodo=8">-->
    						<!--	<img src="../Images/sobre.png">-->
    						<!--</a>-->
    						<a href="grupo.php?accion=libros&info1=B&info2=12030366&info3=ROGV600204NY5">
  		  			...
  		  			<tr> 
  				 <form class='form-inline' action='grupo.php?info1=' method='post' >
  					 <input type="hidden" name="datos[nocontrol]" value="12030188" > 
  					 <td width='500'>Hernández Sierra María del Rosario</td>  					 <td width='500'>  
  					 	<div id="myprogress" style=" position: relative; width: 100%; height: 30px; background-color: #ddd;">	<div id="mybar" style="position: absolute; width: 0% ;height: 100%; background-color: #4caf50;"> 
  					 			<div id="label"style="text-align: center; line-height: 30px; color: white;"> 
  					 				0% 
  					 			</div>
  					...
  					<td width='500'>
  					 ...
  					 <!--Para que no se muestre en la sección del alumno-->
  					  <td><center>
    						<!--<a href="redacta.php?accion=redactarI&info=&receptor=12030188&periodo=8">-->
    						<!--	<img src="../Images/sobre.png">-->
    						<!--</a>-->
    						<a href="grupo.php?accion=libros&info1=B&info2=12030188&info3=ROGV600204NY5">
    							<img src="../Images/libros.png">
    						</a>
  						</center></td>
  		  			...
  		  			<tr> 
  				 <form class='form-inline' action='grupo.php?info1=' method='post' >
  					 <input type="hidden" name="datos[nocontrol]" value="12030186" > 
  					 <td width='500'>Silva Jaraleño Francisco Javier</td>  					 <td width='500'>  
  					 	<div id="myprogress" style=" position: relative; width: 100%; height: 30px; background-color: #ddd;">	<div id="mybar" style="position: absolute; width: 0% ;height: 100%; background-color: #4caf50;"> 
  					 			<div id="label"style="text-align: center; line-height: 30px; color: white;"> 
  					 				0% 
  					 			</div>
  					...
  					<td width='500'>
  					 ...
  					 <!--Para que no se muestre en la sección del alumno-->
  					  <td><center>
    						<!--<a href="redacta.php?accion=redactarI&info=&receptor=12030186&periodo=8">-->
    						<!--	<img src="../Images/sobre.png">-->
    						<!--</a>-->
    						<a href="grupo.php?accion=libros&info1=B&info2=12030186&info3=ROGV600204NY5">
    							<img src="../Images/libros.png">
    						</a>
  						</center></td>
