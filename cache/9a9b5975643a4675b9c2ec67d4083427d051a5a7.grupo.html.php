<?php
/* Smarty version 3.1.30-dev/53, created on 2017-06-28 14:24:38
  from "/home/ubuntu/workspace/templates/admin/grupo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5953bc26c18661_56360332',
...
function content_5953bc26c18661_56360332 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div><label><a href="index.php">index</a></label> > <label><a href="grupos.php">grupos</a></label> > <label>alumnos-libros</label></div>
  ...
  <form action="grupo.php?accion=insert" method="post">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
                <input type="hidden" name="promotor" value="index">
                <input type="hidden" name="datos[cvelectura]" value="25">
        <div class="form-group">
          <label>Libro:</label>
  ...
  <table class='table table-striped'>
    <tr>    
      ...
      <td><center>Al Desnudo</center></td>
      <td>
        <center><a href="grupo.php?accion=delete&info1=13&info2=25" class="delete">
