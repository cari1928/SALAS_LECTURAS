<?php
/* Smarty version 3.1.30-dev/53, created on 2017-06-28 14:37:48
  from "/home/ubuntu/workspace/templates/usuario/form_libro.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5953bf3cc5ce80_84586936',
...
function content_5953bf3cc5ce80_84586936 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="background-color:#337ab7">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">       
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href="datos.php">Tommy Varcetti</a></li>   
      ...
      <label class="navbar-brand"><p style="color: white">Tommy - Alumno</p></label>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
<div><label><a href="index.php">index</a></label> > <label><a href="grupos.php">grupos</a></label> > <label>libro</label></div>
<div class="container-fluid">
  <div class="main row">
    <nav class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3">
	  ...
	  <strong>¡Aviso!</strong> Debe seleccionar mínimo 5 libros
	</div>
      ...
      <form action="grupo.php?accion=insert" method="post">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <input type="hidden" name="datos[cvelectura]" value="26">
            <div class="form-group">
              <label>Libro: </label>
...
<form action="grupo.php?accion=fileinput&info1=26" method="post" enctype="multipart/form-data">
<div class="panel panel-default">
  <div class="panel-heading">
      ...
      <table class='table table-striped'>
        <tr>
          ...
          <th><center>ESTADO</center></th>
            ...
            <td><center>
              <input id="r4" type="radio" class="btn btn-default" value='1' name="datos[reporte]">
            </center></td>
