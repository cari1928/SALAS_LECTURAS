<?php
/* Smarty version 3.1.30-dev/53, created on 2017-06-26 19:48:57
  from "/home/ubuntu/workspace/templates/usuario/form_libro.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_59516529a22655_74888152',
...
function content_59516529a22655_74888152 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <form action="grupo.php?accion=insert" method="post">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <input type="hidden" name="datos[cvelectura]" value="24">
            <div class="form-group">
              <label>Libro: </label>
...
<form action="grupo.php?accion=fileinput&info1=24" method="post" enctype="multipart/form-data">
<div class="panel panel-default">
  <div class="panel-heading">
      ...
      <table class='table table-striped'>
        <tr>
          ...
          <th><center>ESTADO</center></th>
            ...
            <td><center>
              <input id="r4" type="radio" class="btn btn-default" value='6' name="datos[reporte]">
            </center></td>
