...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_58de95da7111a0_85335273',
...
function content_58de95da7111a0_85335273 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="background-color:#337ab7">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">       
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href="datos.php">Pablo 2</a></li>   
      ...
      <label class="navbar-brand"><p style="color: white">Pablo - Alumno</p></label>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
    ...
    <nav class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <input type="hidden" name="datos[cvelectura]" value="23">
            <div class="form-group">
              <label>Libro: </label>
...
<script src="../css/booststrap/fileinput/js/fileinput.min.js" type="text/javascript"></script>
