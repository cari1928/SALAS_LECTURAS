<?php
/* Smarty version 3.1.30-dev/53, created on 2017-01-21 05:31:59
  from "/home/ubuntu/workspace/templates/admin/promotor.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5882f24fd093b9_90226681',
...
function content_5882f24fd093b9_90226681 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<table class='table'>
	...
	<table class='table table-hover'>
		<tr class='info'>		
			...
			<tr>
			<td><center>2222222222222</center></td>
			<td><center>PROMOTOR_PRUEBA</center></td>
			<td><center>PRUEBA@HOTMAIL.COM</center></td>
			<td><center>
									ESPECIALIDAD_PRUEBA
							</center></td>
							<td><center>
					<a class="delete" href="promotor.php?accion=delete&info1=2222222222222">
						<img src="../Images/cancelar.png">
					</a></center></td>
				<td><center><a href="promotor.php?accion=form_update&info1=2222222222222">
					<img src="../Images/edit.png">
				</a></center></td>
										<td><center><a href="promotor.php?accion=mostrar&info1=2222222222222">
			...
			<tr>
			<td><center>NAPE840321PU1</center></td>
			<td><center>Navarro Patiño Edí Jair</center></td>
			<td><center>jair.navarro@itcelaya.edu.mx</center></td>
			<td><center>
									ESCRIBIR_ESPECIALIDAD
							</center></td>
							<td><center>
					<a class="delete" href="promotor.php?accion=delete&info1=NAPE840321PU1">
						<img src="../Images/cancelar.png">
					</a></center></td>
				<td><center><a href="promotor.php?accion=form_update&info1=NAPE840321PU1">
					<img src="../Images/edit.png">
				</a></center></td>
										<td><center><a href="promotor.php?accion=mostrar&info1=NAPE840321PU1">
					<img src="../Images/mostrar.png">
				</a></center></td>
					</tr>
			<tr>
			<td><center>ROGV600204NY5</center></td>
			<td><center>Rodríguez García Victor </center></td>
			<td><center>victor.rodriguez@itcelaya.edu.mx</center></td>
			<td><center>
									ESCRIBIR_ESPECIALIDAD
							</center></td>
							<td><center>
					<a class="delete" href="promotor.php?accion=delete&info1=ROGV600204NY5">
						<img src="../Images/cancelar.png">
					</a></center></td>
				<td><center><a href="promotor.php?accion=form_update&info1=ROGV600204NY5">
					<img src="../Images/edit.png">
				</a></center></td>
										<td><center><a href="promotor.php?accion=mostrar&info1=ROGV600204NY5">
					<img src="../Images/mostrar.png">
				</a></center></td>
					</tr>
		</table>
