<?php
/* Smarty version 3.1.30-dev/53, created on 2016-10-20 09:38:10
  from "/var/www/html/SALAS_LECTURAS/templates/admin/updatepromotor.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5808d6d27c8809_38646788',
...
function content_5808d6d27c8809_38646788 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<center>
  ...
  <div class="form-group">
    ...
    <br/>
    <input class="form-control" id="exampleInputEmail3" placeholder="Nombre y Apellidos" name="datos[nombre]" id="producto" value ='Maria De Jesús (Chuchita)' required>
  </div>
  <br/>
  <br/>
  <label>Especialidad: </label>
    <br/>
      <select name="datos[especialidad]" class="form-control" id="exampleInputEmail3" id="producto"><option>Ingeniería En Sistemas Computacionales</option><option>Ingeniería Informática</option><option>Ingeniería Mecatrónica</option><option>Ingeniería Ambiental</option><option>Ingeniería Bioquímica</option><option>Ingeniería Gestión Empresarial</option><option>Ingeniería Industrial</option><option>Ingeniería Mecánica</option><option>Ingeniería Electrónica </option><option selected>Ingeniería Química</option><option>licenciatura En Administración</option></select>
    <br/>
    <br/>
