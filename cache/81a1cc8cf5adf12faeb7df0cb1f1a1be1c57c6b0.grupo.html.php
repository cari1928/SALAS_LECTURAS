<?php
/* Smarty version 3.1.30-dev/53, created on 2017-06-29 15:19:46
  from "/home/ubuntu/workspace/templates/promotor/grupo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_59551a9251e0f0_42450181',
...
function content_59551a9251e0f0_42450181 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
    	...
    	<th><center>CLAVE</center></th>
			...
			<th width='500'><center>CALIFICACIÓN</center></th>
				...
				<form class='form-inline' 
					action="grupo.php?accion=calificar_reporte&info1=14&info2=24&info3=22222222" 
					method='post'>
				
					<td><center>6</center></td>
					<td><center>50 Cosas que hay que saber de Management</center></td>
					<td><center><select class="form-control" name="cveestado" onchange="location = this.value"><option value="-1">Selecciona una opción</option><option value="grupo.php?accion=estado&estado=1&info=24&info2=22222222&info3=14">En Espera</option><option value="grupo.php?accion=estado&estado=2&info=24&info2=22222222&info3=14"selected>En Proceso</option><option value="grupo.php?accion=estado&estado=3&info=24&info2=22222222&info3=14">Terminado</option><option value="grupo.php?accion=estado&estado=4&info=24&info2=22222222&info3=14">No Terminado</option></select></center></td>
					<td><center>
													<a href="grupo.php?accion=reporte&info1=6&info2=24&info3=8/A/22222222/6_22222222.pdf"> 
					...
					<td width='500'>
						<center>
						 	<div id="myprogress" style=" position: relative; width: 130px; height: 30px; background-color: #ddd;">	
						 		<div id="mybar" style="position: absolute; width: 44% ;height: 100%; background-color: #4caf50;">
						 			<div id="label" 
							...
							<input type="number" class="form-control" name="calificacion" required 
								value="44" style="width:65px; display:block;" 
								maxlength="3" />
					...
					<tr>
				<form class='form-inline' 
					action="grupo.php?accion=calificar_reporte&info1=13&info2=24&info3=22222222" 
					method='post'>
				
					<td><center>14</center></td>
					<td><center>Alera</center></td>
					<td><center><select class="form-control" name="cveestado" onchange="location = this.value"><option value="-1">Selecciona una opción</option><option value="grupo.php?accion=estado&estado=1&info=24&info2=22222222&info3=13">En Espera</option><option value="grupo.php?accion=estado&estado=2&info=24&info2=22222222&info3=13">En Proceso</option><option value="grupo.php?accion=estado&estado=3&info=24&info2=22222222&info3=13"selected>Terminado</option><option value="grupo.php?accion=estado&estado=4&info=24&info2=22222222&info3=13">No Terminado</option></select></center></td>
					<td><center>
					...
					<td width='500'>
						<center>
						 	<div id="myprogress" style=" position: relative; width: 130px; height: 30px; background-color: #ddd;">	
						 		<div id="mybar" style="position: absolute; width: 70% ;height: 100%; background-color: #4caf50;">
						 			<div id="label" 
						 				style="text-align: center; line-height: 30px; color: white;">
						 				70% 
						 			</div>
							...
							<input type="number" class="form-control" name="calificacion" required 
								value="70" style="width:65px; display:block;" 
								maxlength="3" />
							<input type="submit" style='display: none'/>
					 	</center>
					</td>
