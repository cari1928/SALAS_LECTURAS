<?php
/* Smarty version 3.1.30-dev/53, created on 2017-03-24 18:56:19
  from "/home/ubuntu/workspace/templates/promotor/grupo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_58d56bd389a6f4_54896471',
...
function content_58d56bd389a6f4_54896471 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="background-color:#337ab7">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <div class="form-group">
                      <a style="color:white" class="navbar-brand" href="redacta.php?info=&accion=ver&periodo=8">Mensajes</a> 
                  </div>
      </ul>   
      <ul class="nav navbar-nav navbar-right">
        <div class="form-group">
                      <h6><a href="redacta.php?info=&accion=redactar&periodo=8"><img src="../Images/sobre.png"></a></h6>
                  </div>
      </ul>   
  ...
  input[type=number] {
      -moz-appearance:textfield;
			...
			Periodo: 2017-03-22 - 2017-03-26<br>
			Grupo: A
		</div></center>
			...
			<tr>
				...
				<th><center>OPCIONES</center></th>
					 ...
					 <form class='form - inline' action='grupo.php?info1=A' method='post' >
						 <input type="hidden" name="datos[cveeval]" value="5"> 
						 <td width='500' style="vertical-align:middle"> Alumno 3 </td>
						 <td width='500'>
						 	<div id="myprogress" style=" position: relative; width: 100%; height: 30px; background-color: #ddd;">	<div id="mybar" style="position: absolute; width: 80% ;height: 100%; background-color: #4caf50;">
					 	...
					 	<center>
					 		<input type="number" class="form-control" name="datos[asistencia]" required value = "80" style="width:65px ; display:block; "maxlength="3">
					 	</center>
						</td>
						 <td width='500'>  
						 ...
						 <center>
					 		<input type="number" class="form-control" name="datos[comprension]" required value = "50" style="width:65px ; display:block; "maxlength="3">
					 	</center>
						 </td>

						<td width='500'>
							<div id="myprogress" style=" position: relative; width: 100%; height: 30px; background-color: #ddd;">
								<div id="mybar" style="position: absolute; width: 30% ;height: 100%; background-color: #4caf50;">	<div id="label"style="text-align: center; line-height: 30px; color: white;">
										30%
									</div>
								</div>
							</div>
							...
							<center>
								<input type="number" class="form-control" name="datos[participacion]" required value = "30" style="width:65px ; display:block; "maxlength="3">
							</center>
						</td>
						...
						<td width='500'>
					 	...
					 	<center>
					 		<input type="number" class="form-control" name="datos[actividades]" required value = "30" style="width:65px ; display:block; "maxlength="3">
					 	</center>
						</td>
						...
						<td style="vertical-align:middle">
							<a href="redacta.php?accion=redactarI&info1=A&info2=33333333">
								<img src="../Images/sobre.png">
							</a>
							<input type="submit" style='display: none'/>
							<a href="grupo.php?accion=libros&info=5">
