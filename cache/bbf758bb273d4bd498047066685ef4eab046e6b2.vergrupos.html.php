<?php
/* Smarty version 3.1.30-dev/53, created on 2017-11-10 06:31:45
  from "/home/ubuntu/workspace/templates/usuario/vergrupos.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5a0547d1e661e5_76734710',
...
function content_5a0547d1e661e5_76734710 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="background-color:#337ab7">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <a class="navbar-brand" style="color: white"> Jordan - Alumno</a>
      ...
      <ul class="nav navbar-nav navbar-right">      
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href= "grupos.php">Ver todos</a></li><li><a href= "grupo.php?info1=A">A - Los comelibros - Sala 1 Biblioteca Campus 2</a></li>     
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" style="color: white">Cuenta<span class="caret"></span></a>
          <ul class="dropdown-menu">
              <li><a href="datos.php">Jordan</a></li>  
	...
	<table cellspacing=0 cellpadding=2 class="table table-striped">
		<tr>
			...
			<!--<th><center>HORARIO</center></th>-->
				...
				<td><center>Los comelibros</center></td>
