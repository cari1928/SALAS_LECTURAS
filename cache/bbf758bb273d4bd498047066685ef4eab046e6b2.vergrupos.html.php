<?php
/* Smarty version 3.1.30-dev/53, created on 2017-10-10 18:35:54
  from "/home/ubuntu/workspace/templates/usuario/vergrupos.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_59dd130a8778d0_47125462',
...
function content_59dd130a8778d0_47125462 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <ul class="nav navbar-nav navbar-right">      
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href= "grupos.php">Ver todos</a></li><li><a href= "grupo.php?info1=R">R - SALA - R - Red Barrels</a></li>     
          </ul>
        </li>
        <li class="dropdown">
...
<div><label><a href="index.php">index</a></label> > <label>grupos</label></div> 
	<div class="alert alert-info alert-dismissible" role="alert">
	  ...
	  <strong>¡Aviso!</strong> Se ha inscrito correctamente al grupo
	</div>
