<?php
/* Smarty version 3.1.30-dev/53, created on 2017-10-09 03:25:23
  from "/home/ubuntu/workspace/templates/select.component.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_59daec231ee397_23392273',
...
function content_59daec231ee397_23392273 (Smarty_Internal_Template $_smarty_tpl) {
?>
<select class="form-control" name="datos[cvelibro]" >
  <option value="-1">Selecciona una opción</option>
                  <option value="1" >102 Ideas para Enriquecer tu Vida sin Gastar Dinero</option>
                        ...
                        <option value="293" >Attack On Titan</option>
                        <option value="305" >Attack On Titan</option>
                        ...
                        <option value="296" >Outlast</option>
                        <option value="292" >Outlast</option>
                        <option value="294" >Outlast 2</option>
                        <option value="295" >Outlast 2</option>
                        ...
                        <option value="301" >fa</option>
                        <option value="300" >fa</option>
                        <option value="298" >fdas</option>
                        <option value="297" >fdas</option>
                        <option value="302" >nada</option>
                        <option value="303" >nada2</option>
                        <option value="304" >nada3</option>
                        <option value="307" >p</option>
                        <option value="290" >p</option>
                        <option value="299" >p</option>
                        <option value="309" >prueba nex</option>
                        <option value="311" >prueba nex</option>
                        <option value="310" >prueba nex</option>
                        <option value="312" >prueba nex 2</option>
