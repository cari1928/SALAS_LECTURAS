...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_58d56be96c4cf6_55462637',
...
function content_58d56be96c4cf6_55462637 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<center>
  ...
  <label>Correo: </label>
    <br/>
    <input class="form-control" placeholder="Correo" name="datos[correo]" id="producto" maxlength="75" required value= 'jorge2118burguer'>
  ...
  <label>Especialidad: </label>
    <br/>
      <select name="datos[especialidad]" class="form-control" id="exampleInputEmail3" id="producto"><option>Ingeniería En Sistemas Computacionales</option><option>Ingeniería Ambiental</option><option>Ingeniería Bioquímica</option><option>Ingeniería Electrónica</option><option>Ingeniería Gestión Empresarial</option><option>Ingeniería Industrial</option><option>Ingeniería Informática</option><option>Ingeniería Mecatrónica</option><option>Ingeniería Mecánica</option><option>Ingeniería Química</option><option>Licenciatura En Administración</option><option>Otro</option></select>
    <br/>
    <br/>
