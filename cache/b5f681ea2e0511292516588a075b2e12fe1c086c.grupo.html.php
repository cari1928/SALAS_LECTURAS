<?php
/* Smarty version 3.1.30-dev/53, created on 2017-07-26 17:37:03
  from "/home/ubuntu/workspace/templates/usuario/grupo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5978d33feb1724_35333376',
...
function content_5978d33feb1724_35333376 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<style type="text/css">
	...
	<div class="links" style="float:right; padding-bottom:10px">
		...
		<a href="redacta.php?accion=redactar&info=A">
		...
		<tr>
			...
			<th><center>OPCIONES</center></th>
				 ...
				 <form class='form - inline' action='grupo.php?info1=A' method='post' >
					...
					<td width='500'>
						<div id="myprogress" style=" position: relative; width: 100%; height: 30px; background-color: #ddd;"> <div id="mybar" style="position: absolute; width: 23% ;height: 100%; background-color: #4caf50;">	<div id="label"style="text-align: center; line-height: 30px; color: white;">
								23% 
								</div>
							</div>
						</div>
					...
					<td>
						<a href="msj.php?accion=listado&info=A" style="text-decoration:none" >
							<img src="../Images/sobre.png">
						</a>
						<a href="grupo.php?accion=form_libro&info1=24" style="text-decoration:none" >
