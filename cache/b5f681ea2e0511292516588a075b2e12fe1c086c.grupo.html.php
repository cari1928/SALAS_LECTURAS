<?php
/* Smarty version 3.1.30-dev/53, created on 2017-03-31 17:41:23
  from "/home/ubuntu/workspace/templates/usuario/grupo.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_58de94c3796a73_96695377',
...
function content_58de94c3796a73_96695377 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div><label><a href="index.php">index</a></label> > <label><a href="grupos.php">grupos</a></label> > <label>grupo</label></div>
			...
			<div class="form-group" style ="background-color:#f0f0f0">
				<label>
					Grupo: A<br>
					Sala: SALA - A<br>
					Ubicación: Biblioteca campus 1<br>
					Periodo: 2017-02-14 - 2017-06-13<br>
					Promotor: Promotor 1
				</label>
			</div>
		</center>
			...
			<tr>
				...
				<th><center>OPCIONES</center></th>
					 ...
					 <form class='form - inline' action='grupo.php?info1=A' method='post' >
						 <input type="hidden" name="datos[nocontrol]" value="55555555" > 
						 <td width='500'><center>Pablo 2</center></td>
						...
						<td>
							<a href="redacta.php?accion=redactarI&info=A&receptor=55555555&grupo=A&periodo=1">
								<img src="../Images/sobre.png">
							</a>
							<a href="grupo.php?accion=form_libro&info1=23">
