<?php
/* Smarty version 3.1.30-dev/53, created on 2016-10-20 09:46:19
  from "/var/www/html/SALAS_LECTURAS/templates/admin/updateperiodos.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_5808d8bb66dc45_78415721',
...
function content_5808d8bb66dc45_78415721 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<center>
  ...
  <div class="form-group">
    ...
    <br/>
    <input TYPE="date"  class="form-control" id="exampleInputEmail3" name="datos[fechaInicio]" id="producto" require value="2016-10-18">
  </div>
  <br/>
  <br/>
  <div class="form-group">
    ...
    <br/>
    <input TYPE="date"  class="form-control" id="exampleInputEmail3" name="datos[fechaFinal]" id="producto" require value="2016-10-20">
  </div>
  <br/>
  <br/>
  
  <button type="submit" class="btn btn-default" value="3" name="datos[cve]">Crear</button></br>
