<?php
/* Smarty version 3.1.30-dev/53, created on 2017-01-20 17:53:38
  from "/home/ubuntu/workspace/templates/admin/form_alumnos.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_58824ea2bbd8d5_55018161',
...
function content_58824ea2bbd8d5_55018161 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="main row">
    <nav class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">
               Actualizar Alumno - Número de Control: 12030366
                          </h3>
          </div>
          <div class="panel-body">
                          <input type="hidden" name="datos[usuario]" value="12030366">
                        <div class="form-group">
              <label>Nombre Completo: </label>
              <input class="form-control" placeholder="Nombre y Apellidos" name="datos[nombre]" required 
               value="Gonzáles Freyre Isabel" >
            </div>
            <div class="form-group">
        ...
        <option value="-1">Selecciona una opción</option>
              ...
              <option value="IM"  selected >Ingeniería Mecatrónica</option>
              ...
              <input type='email' class="form-control" placeholder="Correo" name="datos[correo]" maxlength="75"
               value="12030366@itcelaya.edu.mx" >
            </div>
