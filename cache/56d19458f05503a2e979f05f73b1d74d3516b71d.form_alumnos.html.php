<?php
/* Smarty version 3.1.30-dev/53, created on 2017-03-31 17:34:14
  from "/home/ubuntu/workspace/templates/admin/form_alumnos.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_58de9316be05b7_90749888',
...
function content_58de9316be05b7_90749888 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3">
      ...
      <form action="alumnos.php?accion=update" method="post">
        <div class="panel panel-default">
          ...
          <div class="panel-heading">
            <h3 class="panel-title">
               Actualizar Alumno - Número de Control: 55555555
                          </h3>
          </div>
          
          <div class="panel-body">
                          <input type="hidden" name="datos[usuario]" value="55555555">
                        <div class="form-group">
        ...
        <option value="-1">Selecciona una opción</option>
              <option value="IA"  selected >Ingeniería Ambiental</option>
              ...
              <input type='email' class="form-control" placeholder="Correo" name="datos[correo]" maxlength="75"
               value="55555555@itcelaya.edu.mx" >
            </div>
