<?php
/* Smarty version 3.1.30-dev/53, created on 2017-10-05 16:57:40
  from "/home/ubuntu/workspace/templates/admin/form_promotores.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/53',
  'unifunc' => 'content_59d66484682295_81191435',
...
function content_59d66484682295_81191435 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container-fluid">
  <div class="main row">
    <nav class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-push-3">
      ...
      <form method="post"
        action="promotor.php?accion=update">  
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading">
            <h3 class="panel-title">
                ...
                Actualizar Promotor - RFC: RIJE640621MGT
                          </h3>
          </div>
          
          <div class="panel-body">
            
                          <input type="hidden" name="cveusuario" value="RIJE640621MGT">
            
            <div class="form-group">
              <label>Nombre Completo:</label>
              <input class="form-control" placeholder="Nombre y Apellidos" name="datos[nombre]"  required
               value="José Jaramillo" >
            </div>

            <div class="form-group">
              <label>Especialidad:</label>
              <label id="l4" style="display:none">Carrera</label>
              <input id="r4" type="radio" class="btn btn-default" value='true' name="datos[especialidad]" style="display:none" onclick="otro()" checked>
              <div id="carrera" class="form-group" style="display:block">
  ...
  <option value="-1">Selecciona una opción</option>
              ...
              <input id="r3" type="radio" value='false' name="datos[especialidad]" style="display:inline" onclick="otro()">
