...
if (!file_exists($nombre_fichero)) {
    $libro[0]['portada'] = "no_disponible.jpg";
}

// $sql = "SELECT * FROM foro WHERE cvelibro = ?";
// $foro = $web->DB->GetAll($sql, $_GET['info']);
// if(!isset($foro[0])){
//     header('Location: index.php?m=4');//El libro no tiene un foro    
// }
