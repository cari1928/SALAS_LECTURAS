 ...
 */
  public function grupos($rfc)
  {
    ...
    if ($rol == 'P') {
      //es un promotor
      $sql = "select cvesala, letra, horario from lectura
   ...
   * @param  String $grupo  [Letra que representa el grupo en donde está el alumno]
  ...
  public function evaluacion($grupo, $display = "block", $aux = "")
  {
